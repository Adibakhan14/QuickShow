import { Bluetooth, ChartLineIcon, CircleDollarSignIcon, PlayCircleIcon, StarIcon, UserIcon } from 'lucide-react';
...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    {title: 'Active Shows', value: dashboardData.activeShows.length || "0", icon:
      PlayCircleIcon },
    {title: 'Total Users', value: dashboardData.totalUsers || "0", icon:
      UserIcon }
  ]
    ...
    <>
      ...
      <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
        ...
        {dashboardData.activeShows.map((show) => (
          ...
          h-full pb-3 bg-primary/10 border border-primary/20 hover:-translate-y-1
